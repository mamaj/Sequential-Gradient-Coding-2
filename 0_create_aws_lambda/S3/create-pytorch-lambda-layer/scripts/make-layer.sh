...
zip -r9 -q requirements.zip torch torchvision || failure_cleanup
rm -rf torch torchvision
...
# cp -r /Users/reza/Projects/aws-lambda/create-dataset-model-layer/python/. python
